...
with plt.style.context(['science']):
    ...
    ax.set(**pparam)
    #fig.show()
    fig.savefig('temp/fig1.pdf')
    fig.savefig('temp/fig1.jpg', dpi=300)
...
with plt.style.context(['science', 'ieee']):
    ...
    fig.savefig('temp/fig2a.pdf')
    fig.savefig('temp/fig2a.jpg', dpi=300)
...
with plt.style.context(['science', 'ieee', 'std-colors']):
    ...
    # Note: $\mu$ doesn't work with Times font (used by ieee style)
    ax.set_ylabel(r'Current (\textmu A)')  
    fig.savefig('temp/fig2b.pdf')
    fig.savefig('temp/fig2b.jpg', dpi=300)
...
with plt.style.context(['science', 'nature']):
    ...
    ax.autoscale(tight=True)
    ax.set(**pparam)
    fig.savefig('temp/fig2c.pdf')
    fig.savefig('temp/fig2c.jpg', dpi=300)
...
with plt.style.context(['science', 'scatter']):
    ...
    ax.set_xlim([-2, 2])
    ax.set_ylim([-2, 2])
    fig.savefig('temp/fig3.pdf')
    fig.savefig('temp/fig3.jpg', dpi=300)
...
with plt.style.context(['science', 'high-vis']):
    ...
    ax.autoscale(tight=True)
    ax.set(**pparam)
    fig.savefig('temp/fig4.pdf')
    fig.savefig('temp/fig4.jpg', dpi=300)
...
with plt.style.context(['dark_background', 'science', 'high-vis']):
    ...
    ax.autoscale(tight=True)
    ax.set(**pparam)
    fig.savefig('temp/fig5.pdf')
    fig.savefig('temp/fig5.jpg', dpi=300)
...
with plt.style.context(['science', 'notebook']):
    ...
    ax.autoscale(tight=True)
    ax.set(**pparam)
    fig.savefig('temp/fig10.pdf')
    fig.savefig('temp/fig10.jpg', dpi=300)
...
with plt.style.context(['science', 'bright']):
    ...
    ax.autoscale(tight=True)
    ax.set(**pparam)
    fig.savefig('temp/fig6.pdf')
    fig.savefig('temp/fig6.jpg', dpi=300)
...
with plt.style.context(['science', 'vibrant']):
    ...
    ax.autoscale(tight=True)
    ax.set(**pparam)
    fig.savefig('temp/fig7.pdf')
    fig.savefig('temp/fig7.jpg', dpi=300)
...
with plt.style.context(['science', 'muted']):
    ...
    ax.autoscale(tight=True)
    ax.set(**pparam)
    fig.savefig('temp/fig8.pdf')
    fig.savefig('temp/fig8.jpg', dpi=300)
...
with plt.style.context(['science', 'retro']):
    ...
    ax.autoscale(tight=True)
    ax.set(**pparam)
    fig.savefig('temp/fig9.pdf')
    fig.savefig('temp/fig9.jpg', dpi=300)
...
with plt.style.context(['science', 'grid']):
    ...
    ax.autoscale(tight=True)
    ax.set(**pparam)
    fig.savefig('temp/fig11.pdf')
    fig.savefig('temp/fig11.jpg', dpi=300)
...
with plt.style.context(['science', 'high-contrast']):
    ...
    ax.autoscale(tight=True)
    ax.set(**pparam)
    fig.savefig('temp/fig12.pdf')
    fig.savefig('temp/fig12.jpg', dpi=300)
...
with plt.style.context(['science', 'light']):
    ...
    ax.autoscale(tight=True)
    ax.set(**pparam)
    fig.savefig('temp/fig13.pdf')
    fig.savefig('temp/fig13.jpg', dpi=300)
...
with plt.style.context(['science', 'no-latex', 'cjk-tc-font']):
    ...
    ax.autoscale(tight=True)
    fig.savefig('temp/fig14a.jpg', dpi=300)
...
with plt.style.context(['science', 'no-latex', 'cjk-sc-font']):
    ...
    ax.autoscale(tight=True)
    fig.savefig('temp/fig14b.jpg', dpi=300)
...
with plt.style.context(['science', 'no-latex', 'cjk-jp-font']):
    ...
    ax.autoscale(tight=True)
    fig.savefig('temp/fig14c.jpg', dpi=300)
...
with plt.style.context(['science', 'no-latex', 'cjk-kr-font']):
    ...
    ax.autoscale(tight=True)
    fig.savefig('temp/fig14d.jpg', dpi=300)
...
with plt.style.context(['science', 'russian-font']):
    ...
    ax.autoscale(tight=True)
    fig.savefig('temp/fig16.jpg', dpi=300)